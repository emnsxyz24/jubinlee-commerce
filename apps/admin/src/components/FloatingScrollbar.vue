<template>
  <div 
    v-if="shouldShow" 
    class="fixed top-5 bottom-5 right-1.5 sm:right-2 z-[9999] w-2.5 flex flex-col justify-start pointer-events-none select-none"
  >
    <div 
      ref="trackRef"
...
const updateScrollbar = () => {
  ...
  const scrollTop = Math.min(maxScroll, Math.max(0, window.scrollY || window.pageYOffset || docEl.scrollTop || (body ? body.scrollTop : 0)));
